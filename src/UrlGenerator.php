...
class UrlGenerator
{
    ...
    public function formatScheme($secure = true)
    {
        if (! is_null($secure)) {
    ...
    {
        $parameters = $this->arrayWrap($parameters);
    ...
    public function formatRoot($scheme, $root = null)
    {
        ...
        $start = $this->stringStartsWith($root, 'http://') ? 'http://' : 'https://';
    ...
    public function arrayWrap($value)
    {
        if (is_null($value)) {
            return [];
        }
    ...
    public function stringStartsWith($haystack, $needles)
    {
